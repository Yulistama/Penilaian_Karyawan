   <div id="page-wrapper">
    ...
    <div class="container-fluid">
             ...
             <div class="card-body">
        <div class="card-body">
         <a class="btn btn-sm btn-success mb-3" href="<?= base_url('Penilaian/add_penilaian')?>"><i class="fas fa-plus"></i> Tambah Data </a>
       </div>
...
<?php $i = 1; ?>
     <tr >
      ...
      <td class="text-center">
        <a class="badge badge-primary" href="<?=base_url('Penilaian/edit')?>"> <i class="fa  fa-edit" > </i> Edit </a><br>

        <a class="badge badge-danger" id="btn-hapus" href="<?=base_url('Penilaian/hapus')?>"> <i class="fa fa-trash"> </i> Delete </a><br>

        <a class="badge badge-success" target="_blank" href="<?=base_url('Penilaian/pdf/')?>"> <i class="fa  fa-file-pdf" > </i> Cetak </a>
