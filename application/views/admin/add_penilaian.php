we  <div id="page-wrapper">
      <div class="header"> 
            <h2 class="page-header">
                           Tambah Penilaian Perestasi Kerja PNS
                        </h2>  
    </div>
  ...
  <div class="card shadow mb-4 border-left-primary" >
   <div class="card-header py-3">
    ...
    <div class="modal-body">
      <form method="post" action="<?= base_url('Penilaian/tambah_aksi') ;?>">
   ...
   <div class="row">
      ...
      <div class="col-md-2">
        <b>Persen SKP </b> 
        <input  type="text" name="persenpengukuran" class="form-control" placeholder="Persen SKP" ></input>
      </div>
      <div class="col-md-2">
        <b>Jumlah SKP </b> 
        <input  type="text" name="jmlhpersenpengukuran" class="form-control" placeholder="Jumlah SKP" ></input>
      </div>
      </div>
...
<br>
      ...
      <div class="col-md-3">
        ...
        <input  type="text" name="persenperilaku" class="form-control" placeholder="Persen Perilaku Kerja" ></input>
      </div>
      <div class="col-md-3">
        <b> Jumlah Perilaku Kerja</b> 
        <input  type="text" name="jumlahpersenperilaku" class="form-control" placeholder="Jumlah Perilaku Kerja" ></input>
      </div>
      <div class="col-md-3">
        <b> Nilai Prestasi Kerja</b> 
        <input  type="text" name="nilaiprestasi" class="form-control" placeholder="Nilai Prestasi Kerja" ></input>
      </div>
      <div class="col-md-3">
        <b> <br></b> 
        <input  type="text" name="pnilaiprestasi" class="form-control" placeholder="" ></input>
      </div>
    </div>
    <br>
