        ...
        <div class="col-12" style="margin-top: 10px; background: white; min-height: 200px">
            <div class="row">
                ...
                <?php foreach($golongan as $item) {?>
                    <form method="post" action="<?= base_url('atasan/mastergolongan/update')?>">
                    <input type="hidden" value="<?php echo $item->id?> " name="id"/>
                        <div class="row">
                            <div class="col-md-4">
                                <b>Golongan</b>
                                <input type="text" value="<?php echo $item->name?>" name="golongan" class="form-control" placeholder="Masukan Golongan" require></input>
                            </div>
                        </div>
                        <br>
                        <div class="row">
