                            ...
                            <div class="row">
                                <div class="col-md-12" style="border: solid 1px gray; padding:50px">
                                    <div class="row">
                                        ...
                                        <form method="post" action="<?= base_url('penilai/dataskp/update_data_skp')?>">
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#nama').change(function(){ 
            ...
            $.ajax({
                url : "<?php echo base_url(); ?>penilai/dataskp/get_detail_karyawan/",
                method : "POST",
                data : {id: id},
                async : true,
                dataType : 'json',
        ...
        $('#nama_pp').change(function(){ 
            ...
            $.ajax({
                url : "<?php echo base_url(); ?>penilai/dataskp/get_detail_penilai/",
                method : "POST",
                data : {id: id},
                async : true,
                dataType : 'json',
