...
class DataSKP extends CI_Controller {
    ...
    function __construct(){
		...
		$this->load->model('penilai/m_dataskp');
	}
    ...
    public function index()
    {
        ...
        $this->load->view('pages/penilai/data_skp/index', $data);
    ...
    public function add_data_skp()
    {
        ...
        $this->load->view('template/v_header' , $title);
        $this->load->view('template/v_sidebar');
        $this->load->view('pages/penilai/data_skp/data_skp/index', $data);
        $this->load->view('template/v_footer');
    }
    ...
    public function add_cover()
    {
        ...
        $this->load->view('template/v_header' , $title);
        $this->load->view('template/v_sidebar');
        $this->load->view('pages/penilai/data_skp/cover/index');
        $this->load->view('template/v_footer');
    }
    ...
    public function add_formulir()
    {
        ...
        $this->load->view('template/v_header' , $title);
        $this->load->view('template/v_sidebar');
        $this->load->view('pages/penilai/data_skp/formulir_skp/index');
        $this->load->view('template/v_footer');
    }
    ...
    public function add_pengukuran_capa()
    {
        ...
        $this->load->view('template/v_header' , $title);
        $this->load->view('template/v_sidebar');
        $this->load->view('pages/penilai/data_skp/pengukuran_skp/index');
        $this->load->view('template/v_footer');
    }
    ...
    public function add_prilaku_kerja()
    {
        ...
        $this->load->view('template/v_header' , $title);
        $this->load->view('template/v_sidebar');
        $this->load->view('pages/penilai/data_skp/prilaku_kinerja/index');
        $this->load->view('template/v_footer');
    }
    ...
    public function add_penilaian_kerja()
    {
        ...
        $this->load->view('template/v_header' , $title);
        $this->load->view('template/v_sidebar');
        $this->load->view('pages/penilai/data_skp/penilaian_kerja/index');
        $this->load->view('template/v_footer');
    }
    ...
    public function add_spt()
    {
        ...
        $this->load->view('template/v_header' , $title);
        $this->load->view('template/v_sidebar');
        $this->load->view('pages/penilai/data_skp/spt_dp3/index');
        $this->load->view('template/v_footer');
    }
    // e.tampil form
    ...
    public function edit_skp($id)
    {
        ...
        $this->load->view('template/v_header' , $title);
        $this->load->view('template/v_sidebar');
        $this->load->view('pages/penilai/data_skp/edit_skp', $data);
        $this->load->view('template/v_footer');
    }
    ...
    public function edit_data_skp($id)
    {
        ...
        $this->load->view('template/v_header' , $title);
        $this->load->view('template/v_sidebar');
        $this->load->view('pages/penilai/data_skp/data_skp/edit', $data);
        $this->load->view('template/v_footer');
    }
    ...
    public function edit_cover($id)
    {
        ...
        $this->load->view('template/v_header' , $title);
        $this->load->view('template/v_sidebar');
        $this->load->view('pages/penilai/data_skp/cover/edit', $data);
        $this->load->view('template/v_footer');
    }
    ...
    public function edit_formulir($id)
    {
        ...
        $this->load->view('template/v_header' , $title);
        $this->load->view('template/v_sidebar');
        $this->load->view('pages/penilai/data_skp/formulir_skp/edit', $data);
        $this->load->view('template/v_footer');
    }
    ...
    public function edit_pengukuran($id)
    {
        ...
        $this->load->view('template/v_header' , $title);
        $this->load->view('template/v_sidebar');
        $this->load->view('pages/penilai/data_skp/pengukuran_skp/edit', $data);
        $this->load->view('template/v_footer');
    }
    ...
    public function edit_prilaku_kerja($id)
    {
        ...
        $this->load->view('template/v_header' , $title);
        $this->load->view('template/v_sidebar');
        $this->load->view('pages/penilai/data_skp/prilaku_kinerja/edit', $data);
        $this->load->view('template/v_footer');
    }
    ...
    public function edit_penilaian_kerja($id)
    {
        ...
        $this->load->view('template/v_header' , $title);
        $this->load->view('template/v_sidebar');
        $this->load->view('pages/penilai/data_skp/penilaian_kerja/edit', $data);
        $this->load->view('template/v_footer');
    }
    ...
    public function edit_spt($id)
    {
        ...
        $this->load->view('template/v_header' , $title);
        $this->load->view('template/v_sidebar');
        $this->load->view('pages/penilai/data_skp/spt_dp3/edit', $data);
        $this->load->view('template/v_footer');
    }
    // e.tampil edit form
    ...
    public function v_add_dataskp()
    {
	    ...
	    redirect('penilai/dataskp/add_cover');
    }
    ...
    public function v_add_cover()
    {
	    ...
	    redirect('penilai/dataskp/add_formulir');
    }
    ...
    public function v_add_formulir()
    {
	    ...
	    redirect('penilai/dataskp/add_pengukuran_capa');
    }
    ...
    public function v_add_pengukuran()
    {
	    ...
	    redirect('penilai/dataskp/add_prilaku_kerja');
    }
    ...
    public function v_add_prilaku_kerja()
    {
	    ...
	    redirect('penilai/dataskp/add_penilaian_kerja');
    }
    ...
    public function v_add_penilaian_kerja()
    {
	    ...
	    redirect('penilai/dataskp/add_spt');
    }
    ...
    public function update_data_skp()
    {
        ...
        $this->m_dataskp->update_skp($where, $dataskp,'tbl_dataskp');
        redirect('penilai/dataskp/edit_skp/'.$id_skp);
    }
